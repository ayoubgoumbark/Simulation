...
<div class="card pricing-card pricing-plan-basic">
           ...
           <!--      <p class="pricing-plan-title">Basic</p> -->
                <h3 class="pricing-plan-cost ml-auto  mt-5 " id="priceMRH">----- DH</h3>
                <b>Garanties</b>
                <ul class="pricing-plan-features">
                    
                  <li v-for="garantie in plan.listeGarantieMRH" :key="garantie.idGarantie">
                 
                  <i  class="fas fa-check"></i>{{garantie.libelleGarantie}}
                  
                  </li>
               
                </ul>

                <button type="button" class="btn pricing-plan-purchase-btn">
                  Choisir
                </button>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    validate:function(e)
    {
           ...
           document.getElementById(e.target.id).closest(".card").classList.remove("cardrotate");  
            document.getElementById("carloading").remove();  
         document.getElementById(e.target.id).closest(".card").style.boxShadow =""; 
          document.getElementById(e.target.id).closest(".card").querySelector(".back").style.display = "none";
           document.getElementById(e.target.id).closest(".card").querySelector(".Front").style.display = "block"; 
               }, 2500); 
  ...
  getprice(){
       ...
       const interval = 400;
       var element= document.getElementById("priceMRH")    //this.$refs.price 
